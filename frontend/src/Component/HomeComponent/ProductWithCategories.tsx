                            ...
                            <div className="row">
                                ...
                                >
                                    <div className="cardProduct wow fadeInUp">
                                        ...
                                        <div className="cardInfo">
                                            <a href="product-single.html">
                                                <h6 className="font-md-bold cardTitle">Baby Bear Hoodie</h6>
                                            </a>
                                            <p className="font-lg cardDesc">$16.00</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="cardProduct wow fadeInUp">
                                        <div className="cardImage">
                                            ...
                                            <a href="product-single.html">
                                                <img
                                                    className="imageMain"
                                                    src="assets/imgs/page/homepage1/product5.png"
                                                    alt="kidify"
                                                />
                                                <img
                                                    className="imageHover"
                                                    src="assets/imgs/pa(data-wow-delay%3d_.1s_)ge/homepage1/product3.html"
                                                    alt="kidify"
                                                />
                                            </a>
                                            <div className="button-select">
                                        ...
                                        <div className="cardInfo">
                                            <a href="product-single.html">
                                                <h6 className="font-md-bold cardTitle">Petite Plaid Skirt</h6>
                                            </a>
                                            <p className="font-lg cardDesc">$16.00</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="cardProduct wow fadeInUp">
                                        <div className="cardImage">
                                            ...
                                            <a href="product-single.html">
                                                <img
                                                    className="imageMain"
                                                    src="assets/imgs/page/homepage1/product6.png"
                                                    alt="kidify"
                                                />
                                                <img
                                                    className="imageHover"
                                                    src="assets/imgs/page/homepage1/product4.png"
                                                    alt="kidify"
                                                />
                                            </a>
                                            <div className="button-select">
                                    ...
                                    <div className="cardProduct wow fadeInUp">
                                        <div className="cardImage">
                                            ...
                                            <a href="product-single.html">
                                                <img
                                                    className="imageMain"
                                                    src="assets/imgs/page/homepage1/product7.png"
                                                    alt="kidify"
                                                />
                                                <img
                                                    className="imageHover"
                                                    src="assets/imgs/page/homepage1/product2.png"
                                                    alt="kidify"
                                                />
                                            </a>
                                            <div className="button-select">
                                        ...
                                        <div className="cardInfo">
                                            <a href="product-single.html">
                                                <h6 className="font-md-bold cardTitle">Junior Jersey Dress</h6>
                                            </a>
                                            <p className="font-lg cardDesc">$16.00</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="cardProduct wow fadeInUp">
                                        <div className="cardImage">
                                            ...
                                            <a href="product-single.html">
                                                <img
                                                    className="imageMain"
                                                    src="assets/imgs/page/homepage1/product8.png"
                                                    alt="kidify"
                                                />
                                                <img
                                                    className="imageHover"
                                                    src="assets/imgs/page/homepage1/product3.png"
                                                    alt="kidify"
                                                />
                                            </a>
                                            <div className="button-select">
                                        ...
                                        <div className="cardInfo">
                                            <a href="product-single.html">
                                                <h6 className="font-md-bold cardTitle">Toddler Tutu Dress</h6>
                                            </a>
                                            <p className="font-lg cardDesc">$16.00</p>
                                        </div>
                                    </div>

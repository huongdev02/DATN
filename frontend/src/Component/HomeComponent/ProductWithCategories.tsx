      ...
      <section className="section block-section-2">
        <div className="container">
          <div className="box-info-section2">
            <h2 className="heading-banner mb-25 wow animate__animated animate__bounceIn">
              <span className="text-up">Special sale</span>
              <span className="text-under">Special sale</span>
            </h2>
            <p className="font-3xl-bold neutral-900 mb-35 wow animate__animated animate__fadeIn">
              Special promotions for our regular
              <br className="d-none d-lg-block" />
              customers. Time is limited.
            </p>
            <a className="btn btn-brand-3" href="/product">
              SHOP NOW
            </a>
          </div>
          <div className="block-sale-60 wow animate__animated animate__bounceIn">
            <img src={Sale} alt="Kidify" />
          </div>
          <div className="block-section-img wow animate__animated animate__fadeIn">
            <img src={Banner} alt="Kidify" />
          </div>
        </div>
      </section>
      <div
                        ...
                        >
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a className="glightbox" href={ProductDetail}>
                                <img src={ProductDetail} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a className="glightbox" href={ProductDetailTwo}>
                                <img src={ProductDetailTwo} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a
                                className="glightbox"
                                href={ProductDetailThree}
                              >
                                <img src={ProductDetailThree} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a className="glightbox" href={ProductDetailFour}>
                                <img src={ProductDetailFour} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a className="glightbox" href={ProductDetailFive}>
                                <img src={ProductDetailFive} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                          <SwiperSlide>
                            <figure className="border-radius-10">
                              <a className="glightbox" href={ProductDetailSix}>
                                <img src={ProductDetailSix} alt="kidify" />
                              </a>
                            </figure>
                          </SwiperSlide>
                        </Swiper>
                    ...
                    <div className="col-lg-6 box-images-product-middle">
                      <div className="box-product-info">
                        ...
                        <div className="block-quantity">
                          <div className="font-sm neutral-500 mb-15">
                            Quantity
                          </div>
                        </div>

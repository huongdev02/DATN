                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <span className="brand-1">
                              {Math.round(cart.total).toLocaleString("vi-VN", {
                                style: "currency",
                                currency: "VND",
                              })}
                            </span>
              ...
              <div className="row">
                ...
                <div className="col-lg-4 mb-30">
                  <div className="box-cart-total">
                    <div className="item-total">
                      ...
                      <span className="font-md-bold">$2.51</span>
                    </div>
                    <div className="item-total">
                    ...
                    <div className="item-total border-0">
                      ...
                      <span className="font-xl-bold">$2.51</span>
                    </div>
                    <Link
                      to="/check-out"
                      className="btn btn-brand-1-xl-bold w-100 font-sm-bold"
                    >
                      Proceed To CheckOut
                    </Link>
                  </div>
                ...
                <div className="col-lg-3 mb-30">
                  <div className="box-button-checkout">
                    <a className="btn btn-brand-1-border-2 mr-10" href="#">
                      Continue Shopping
                      <svg
                    ...
                    <a className="btn btn-brand-1-bold" href="#">
                      <svg
                      ...
                      >
                        <path
                          d="M2.00002 8C2.00002 4.68629 4.68631 2 8.00002 2C9.88486 2 11.5667 2.86911 12.6667 4.22844"
                          stroke="white"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M13 2L13 4.66667L10.3333 4.66667"
                          stroke="white"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M14 8C14 11.3137 11.3137 14 8.00001 14C6.11517 14 4.43331 13.1309 3.33334 11.7716"
                          stroke="white"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M3 14L3 11.3333L5.66667 11.3333"
                          stroke="white"
                          strokeWidth="1.33333"
                          strokeLinecap="round"
                          strokeLinejoin="round"

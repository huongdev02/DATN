                                ...
                                <table className="table table-striped table-cart">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="box-product-cart"><a className="image-product-cart" href="#"><img src={Product} alt="kidify" /></a><a className="title-product-cart" href="product-single.html">Chevron Long Dress</a></div>
                                            </td>
                                            <td><span className="size-product">XL</span></td>
                                            <td><span className="brand-1">$18.50</span></td>
                                            <td>
                                                <div className="product-quantity">
                                                    <div className="quantity"><span className="icon icon-minus d-flex align-items-center">
                                                        ...
                                                        <input className="input-quantity border-0 text-center" type="text" defaultValue={1} /><span className="icon icon-plus d-flex align-items-center">
                                                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <td><span className="brand-1">$37.0</span></td>
                                            <td><a href="#">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 mb-30">
                                    <div className="box-cart-total">
                                        <div className="item-total"><span className="font-sm">Subtotal</span><span className="font-md-bold">$2.51</span></div>
                                        ...
                                        <div className="item-total border-0"><span className="font-sm">Total</span><span className="font-xl-bold">$2.51</span></div><Link to='/check-out' className="btn btn-brand-1-xl-bold w-100 font-sm-bold">Proceed To CheckOut</Link>
                                    </div>
                                </div>

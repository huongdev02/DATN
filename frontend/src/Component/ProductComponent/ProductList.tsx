  ...
  <div className="box-product-lists">
    <div className="row">
      <div className="col-xl-4 col-sm-6">
        <div className="cardProduct wow fadeInUp">
          <div className="cardImage">
            <label className="lbl-hot">hot</label><Link to='/product-detail'><img className="imageMain" src={ProductOne} alt="kidify" /><img className="imageHover" src={ProductTwo} alt="kidify" /></Link>
            <div className="button-select"><Link to='/product-detail'>Add to Cart</Link></div>
          ...
          <div className="cardInfo"><Link to='/product-detail'>
              <h6 className="font-md-bold cardTitle">Lace Shirt Cut II</h6></Link>
      ...
      <div className="col-xl-4 col-sm-6">
        <div className="cardProduct wow fadeInUp">
          <div className="cardImage">
            <label className="lbl-hot">hot</label><Link to='/product-detail'><img className="imageMain" src={ProductThree} alt="kidify" /><img className="imageHover" src={ProductFour} alt="kidify" /></Link>
            <div className="button-select"><Link to='/product-detail'>Add to Cart</Link></div>
            <div className="box-quick-button"><a className="btn" aria-label="Quick view" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                <svg className="d-inline-flex align-items-center justify-content-center" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
      ...
      <div className="col-xl-4 col-sm-6">
        <div className="cardProduct wow fadeInUp">
          <div className="cardImage">
            <label className="lbl-hot">hot</label><Link to='/product-detail'><img className="imageMain" src={ProductSeven} alt="kidify" /><img className="imageHover" src={ProductSix} alt="kidify" /></Link>
            <div className="button-select"><Link to='/product-detail'>Add to Cart</Link></div>
            <div className="box-quick-button"><a className="btn" aria-label="Quick view" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                <svg className="d-inline-flex align-items-center justify-content-center" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />

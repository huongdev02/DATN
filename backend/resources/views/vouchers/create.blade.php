    ...
    <div class="container">
        <form method="POST" action="{{ route('vouchers.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="number" class="form-control" step="0.01" name="max_discount" id="max_discount" value="{{ old('max_discount', 0) }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="number" class="form-control" name="used_times" id="used_times" value="{{ old('used_times', 1) }}" required>
                </div>
            </div>
